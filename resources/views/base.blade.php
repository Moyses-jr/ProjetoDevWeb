            ...
            <div>
                <div class="text-white">
                    ...
                    <div class="flex justify-center">
                        <div class="">
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400" src="https://pbs.twimg.com/media/FNhKDVWWYAM3RRY.jpg" alt="">
                    ...
                    <form action="{{route('estoque.busca')}}" method="post">
                        ...
                        <div class="flex justify-center  mt-2 mr-4">
                            <div class="relative flex w-full flex-wrap items-stretch mb-3">
                                <input name="busca" type="search" placeholder="Search" class="form-input px-3 py-2 placeholder-gray-400 text-gray-700 relative bg-white rounded-lg text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full pr-10" />
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            ...
                            <div class="col-span-12 mt-5">
                                ...
                                @if (session('sucesso'))
                                <div>Deu bom {{ session('sucesso')}}</div>
                                @endif
